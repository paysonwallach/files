        ...
        if (action != null) {
            ...
            switch (action.type) {
                ...
                case Marlin.UndoActionType.CREATEFOLDER:
                    ...
                    if (confirm_delete) {
                        Marlin.FileOperations.@delete (uris, null, () => {undo_redo_done_transfer_callback (action);});
                    } else {
                ...
                case Marlin.UndoActionType.RESTOREFROMTRASH:
                    uris = gfile_list_from_folder (action.destinations, action.dest_dir);
                    Marlin.FileOperations.trash_or_delete (uris, null, () => {undo_redo_done_transfer_callback (action);});
                    break;
                case Marlin.UndoActionType.MOVETOTRASH:
                ...
                case Marlin.UndoActionType.RENAME:
                    ...
                    PF.FileUtils.set_file_display_name.begin (file, new_name, null, (obj, res) => {
                        try {
